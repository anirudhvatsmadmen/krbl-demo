            ...
            >
              <View style={styles.tripInfo}>
                <View style={styles.statusContainer}>
                  {/* <Text style={styles.statusText}>{calculateDaysLeft()}</Text> */}
                </View>
...
const styles = StyleSheet.create({
  ...
  dateColumn: { width: 60, alignItems: "center", justifyContent: "center" },
  day: { color: "#000", fontSize: 16 },
  month: { color: "#000", fontSize: 12 },
  ...
  subtitle: { color: "#fff", fontSize: 14, fontWeight: "bold", maxWidth: 200 },
